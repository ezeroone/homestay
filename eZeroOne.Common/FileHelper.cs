   ...
   public static  class FileHelper
    {
        ...
        public static void SaveResizedImage(string filePath, string fileThumpPath, string filename, string resizedFilename, int width, int height)
        {
            //Image origImg = Image.FromFile(Path.Combine(filePath, filename));
            Image origImg = Image.FromFile(filePath);
            Image resizedImg = FixedSize(origImg, width, height);

            resizedImg.Save(Path.Combine(fileThumpPath, resizedFilename), ImageFormat.Jpeg);
            resizedImg.Dispose();
            origImg.Dispose();
        }
