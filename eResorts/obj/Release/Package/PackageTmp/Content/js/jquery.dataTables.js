    ...
    var j = function (e) {
        ...
        function za(a) {
            var b = a.oPreviousSearch,
                ...
                c = -1 !== c.indexOf("_INPUT_") ? c.replace("_INPUT_", '<input type="text" placeholder="type in any letter or word ..." />') : "" === c ? '<input type="text" placeholder="type in any letter or word ..." />' : c + ' <input type="text" placeholder="type in any letter or word ..." />',
        ...
        function ya(a) {
            ...
            var b = '<select style="width:65px;" id="ddlShow" size="1" ' + ('name="' + a.sTableId + '_length"') + ">",
                c, d, g = a.aLengthMenu;
        ...
        function Sa(a) {
            for (var b = V.location.pathname.split("http://wbpreview.com/"), a = a + "_" + b[b.length - 1].replace(/[\/:]/g, "").toLowerCase() + "=", b = l.cookie.split(";"), c = 0; c < b.length; c++) {
                for (var d = b[c];
