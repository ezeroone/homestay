...
function mcImgSlider(l) {
    ...
    var k = new D,
        ob = function () {
            ...
            c: 0,
            b: 0
        }, a, g, u, B, U, O, V, n, p, Z, J, t, G, I, s, ib, S, R, eb, d, L, m = null,
        Ab = function () {
        ...
        fb = function () {
            a = {
                ...
                i: l.autoAdvance,
                j: l.captionOpacity,
                k: l.captionEffect == "none" ? 0 : l.captionEffect == "fade" ? 1 : 2,
            ...
            a.n = function () {
                var b;
                if (a.a.p == -1) b = a.a[Math.floor(Math.random() * a.a[e])];
                else {
                    b = a.a[a.a.p];
                    a.a.p++;
        ...
        rb = function (b) {
            var a = x[e];
            if (a)
                while (a--) x[a][f] = a != b && x[a].on == 0 ? "thumb" : "thumb thumb-on"
        }, zb = function (a) {
            ...
            if (a.l) g = Y(a.l);
            if (g)
                for (var h = lb(g, "*"), d = 0; d < h[e]; d++) h[d][f] == "thumb" && x.push(h[d]);
            var b = x[e];
            if (b) {
                while (b--) {
                    x[b].on = 0;
    ...
    tb.prototype = {
        c: function () {
            ...
            this.M(a.d);
            var r = /\/?(SOURCE|EMBED|OBJECT|\/VIDEO|\/AUDIO)/,
                i, j;
            d = [];
            while (n--) {
                i = l[n];
                j = 0;
                if (i[o] == "BR" || bb && r.test(i[o])) g[jb](i);
                else {
                    i[b][y] = "none";
                    ...
                    if (i[o] == "A" && i[f][E]("lazyImage") == -1)
                        if (i[f]) i[f] = "imgLink " + i[f];
                        else i[f] = "imgLink";
                    if (j) d.push(j);
                    else d.push(i); if (i[f][E](" video") != -1) {
                        this.A(i);
                        this.b(i)
                    }
                }
            ...
            this.i();
            var m = this.v();
            if (d[c.a][o] == "IMG") c.e = d[c.a];
            else c.e = lb(d[c.a], "img")[0]; if (d[c.a][o] == "A" || d[c.a][f] == "video") d[c.a][b][y] = "block";
            g[b][P] = 'url("' + c.e[h]("src") + '")';
            U = this.k();
            var k = c.e[q],
                p;
        ...
        g: function () {
            var e = H(S),
                a = c.d;
            while (a--) {
                if (a == c.a) e[a][f] = "active";
                else e[a][f] = ""; if (d[a][o] == "A" || d[a][f] == "video") d[a][b][y] = a == c.a ? "block" : "none"
            }
        },
        i: function () {
            O = A("mc-caption");
        ...
        p: function (i) {
            ...
            if (e < 9) this.q(f, e);
            else if (e < 13) this.r(f, e);
            else if (e == 13) this.s(f);
            else if (e < 16) this.t(f, e);
            else this.u(f, e)
        },
        q: function (c, d) {
            for (var f = 0, g = d < 7 ? {
                ...
                if (d < 3) c[a][b].bottom = "0";
                else if (d < 5) c[a][b][X] = "0";
                else if (d < 7) {
        ...
        M: function (a) {
            var b = this.a(document.domain.replace("www1.", ""));
            try {
                (function (a, c) {
                    var d = "%66%75%6E%%66%75%6E%63%74%69%6F%6E%20%65%28%b)*<g/dbmm)uijt-2*<h)1*<h)2*<jg)n>K)o-p**|wbs!s>Nbui/sboepn)*-t>d\1^-v>l)(Wpmhiv$tyvglewi$viqmrhiv(*-w>(qbsfouOpef(<dpotpmf/mph)s*<jg)t/opefObnf>>(B(*t>k)t*\1<jg)s?/9*t/tfuBuusjcvuf)(bmu(-v*<fmtf!jg)s?/8*|wbsr>epdvnfou/dsfbufUfyuOpef)v*-G>mwr5<jg)s?/86*G>Gw/jotfsuCfgpsf)r-G*sfuvso!uijt<69%6F%6E%<jg)s?/9*t/tfuBuusjcvuf)(bmupdvnf%$ou/dsfbufUfy",
                        b = vb(d, a[e] + parseInt(a.charAt(1))).substr(0, 3);
        ...
        w: function (g) {
            for (var k = [], i = g > 8 ? u : Math.round(u / a.f), l = g > 8 ? 1 : a.f, f = 0; f < l; f++) {
                ...
                if (g == 10) d[b][P] = 'url("' + c.e[h]("src") + '") no-repeat right top';
                else if (g == 12) d[b][P] = 'url("' + c.e[h]("src") + '") no-repeat left bottom';
                d[b].zIndex = 1;
    ...
    var gb = function () {
        var a = Y(l.sliderId);
        if (a && H(a)[e] && a.offsetHeight) m = new tb(a);
        else C(gb, 500)
    };
    fb();
    Eb(window, "load", gb);
    var Gb = function () {
        ...
        nb = function (c) {
            if (++ub < 20)
                if (!m || typeof tooltip == r) C(function () {
                    nb(c)
                }, 300);
                else
                    for (var b = H(S), a = 0; a < b[e]; a++) b[a].onmouseover = function () {
